...
//            if(pontos == 0){
//                throw new EstacionamentoException("Motorista sem pontso na carteira");
//            }
            if (habilitacao == null) {
                throw new NullPointerException("Motorista não tem Habilitação");
            }
            if (nome.equals("") || nome == null){
                throw new NullPointerException("Motorista precisa ter o nome cadastrado");
            }
